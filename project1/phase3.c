...
// Thread 1: transfer_deadlock_example(0, 1, amount) // Locks 0, wants 1
// Thread 2: transfer_deadlock_example(1, 0, amount) // Locks 1, wants 0
    pthread_t thread1;
    pthread_t thread2;
    pthread_create(thread1, NULL, transfer_deadlock_example, &(0, 1, amount));
